...
func init() {
	connection.RegisterHandler(connection.StateLogin, connection.PacketId(connection.ServerPacketEncryptionResponse), HandleEncryption)
}

func HandleEncryption(conn *connection.Connection, reader *bufio.Reader, packet packets.Packet) (bool, error) {
